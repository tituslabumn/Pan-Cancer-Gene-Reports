...
```{r echo=FALSE, fig.asp=1, out.width='\\textwidth'}
...
```{r echo=FALSE, fig.asp=1}
lolliplot(SNP.gr = list(A1 = F5_gnomAD_overlap, A2 = F5_cBP_overlap),
          features = list(No_name_features,F5_features),
          ranges = F5_ranges, 
          xaxis = F5_x_axis,
          cex = 0.75,
          ylab = c("ylab2","ylab1"),
