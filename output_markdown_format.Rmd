...
if(length(F4_variants$score)>0){
  ...
  legend(100,675,
         c("Gain of charge","Loss of charge","charge reversed","multi-category"),
         pch = c(2,6,5,0), # "triangle point up","triangle point down","diamond","square"
         cex = 1.5,
         bty = "n",
         ncol = 2
         )
...
if(length(F7_variants$score)>0){
  ...
  par(mar=c(0,2,1,0)) # (bottom,left,top,right)
