...
## gnomAD Missense mutations (n = **`r length(F10_variants$score)`**) [colors categorize reference AA]
...
## gnomAD Frameshifts and stops gained/lost (n = **`r length(F11_variants$score)`**)
...
## gnomAD Insertions/Deletions  (n = **`r length(F12_variants$score)`**)
