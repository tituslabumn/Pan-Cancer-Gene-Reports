...
## gnomAD Frameshifts and stops gained/lost (n = **`r length(F10_variants$score)`**)
...
lolliplot(SNP.gr = list(A1 = GRanges(),A2 = F10_gnomAD_overlap, A3 = F10_cBP_overlap),
          features = list(A3 = Feature_legend, A4 = No_name_features, A5 = No_name_features),
          ranges = F10_ranges, 
          xaxis = FALSE,#,F10_x_axis,F10_x_axis)
          cex = 0.75,
