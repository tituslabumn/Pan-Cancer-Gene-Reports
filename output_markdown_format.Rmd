...
```{r echo=FALSE,fig.width=12,out.width='\\textwidth',strip.white=TRUE}
...
```
## cBioPortal Missense mutations (n = **`r length(F7_variants$score)`**)
```{r echo=FALSE,fig.width=14,fig.height=4.5,out.width='\\textwidth'}
...
```
## cBioPortal Splice regions and splice sites (acceptors/donors) (n = **`r length(F7_variants$score)`**)
```{r echo=FALSE,fig.width=14,fig.height=4.5,out.width='\\textwidth'}
...
```{r echo=FALSE,fig.width=12,fig.height=14,out.width='\\textwidth',strip.white=TRUE}
if(length(F7_variants$score)>0){
